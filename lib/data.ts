  ...
  settings: [
    {
      ...
      site: {
        name: 'Xbox Store',
        description:
          'Xbox Store - متجرك الرسمي لكل ما يتعلق بـ Xbox! نوفر أحدث الألعاب، اشتراكات Xbox Game Pass Ultimate، بطاقات هدايا Xbox، إكسسوارات Xbox Series X|S، وحدات التحكم، سماعات الألعاب، وكل ما تحتاجه لتجربة ألعاب استثنائية. تسوق الآن واستمتع بأفضل الأسعار والعروض الحصرية!',
        keywords: 'Xbox، Xbox Store، ألعاب Xbox، Xbox Game Pass، Xbox Live Gold، بطاقات هدايا Xbox، Xbox Series X، Xbox Series S، وحدات تحكم Xbox، إكسسوارات Xbox، اشتراكات Xbox، ألعاب إلكترونية، متجر ألعاب، Game Pass Ultimate',
        url: 'https://xbox-store.com',
        logo: '/icons/logo.png',
        slogan: 'عالم Xbox بين يديك - اكتشف، العب، استمتع',
        author: 'Xbox Store',
        copyright: '2024، Xbox Store، جميع الحقوق محفوظة.',
        email: 'support@xbox-store.com',
        address: 'القاهرة، مصر',
